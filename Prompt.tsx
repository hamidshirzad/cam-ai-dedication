...
export function Prompt() {
  ...
  const get2dPrompt = () =>
    `Detect ${targetPrompt}, with no more than 20 items. Output a json list where each entry contains the 2D bounding box in "box_2d", ${
      labelPrompt || 'a text label'
    } in "label", and a confidence score between 0.0 and 1.0 in "confidence".`;
